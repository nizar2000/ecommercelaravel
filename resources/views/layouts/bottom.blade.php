...
<script src="{{ asset('client_assets/js/jquery-ui.js') }}"></script>
...
<script src="{{ asset('client_assets/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('client_assets/js/aos.js') }}"></script>
